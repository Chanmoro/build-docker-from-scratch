...
static PyObject * pivot_root(PyObject *self, PyObject *args) {
...
static PyObject * _umount2(PyObject *self, PyObject *args) {
    const char *target;
    int flags;
...
static PyObject * _clone(PyObject *self, PyObject *args) {
...
static PyObject * _sethostname(PyObject *self, PyObject *args) {
    const char *hostname;
...
static struct PyModuleDef Linux = {
...
{
    // clone constants
    PyObject *module = PyModule_Create(&Linux);
